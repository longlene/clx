...
REBAR_APP_SRC="src/leo_dcerl.app.src"

inherit rebar

LIBCUTIL_PV="0.5.1"

DESCRIPTION="Disc cache library for Erlang with an LRU C NIF"
HOMEPAGE="https://github.com/leo-project/leo_dcerl"
SRC_URI="
	https://github.com/leo-project/leo_dcerl/archive/refs/tags/v${PV}.tar.gz
		-> ${P}.gh.tar.gz
	https://github.com/leo-project/libcutil/archive/refs/tags/${LIBCUTIL_PV}.tar.gz
		-> libcutil-${LIBCUTIL_PV}.gh.tar.gz
"
S="${WORKDIR}/leo_dcerl-${PV}"
