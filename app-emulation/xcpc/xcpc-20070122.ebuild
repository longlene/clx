...
DESCRIPTION="Xcpc - Amstrad CPC Emulator"

# Homepage, not used by Portage directly but handy for developer reference
HOMEPAGE="http://xcpc.emuunlim.com/"

# Point to any required sources; these will be automatically downloaded by
# Portage.
SRC_URI="mirror://sourceforge/xcpc/${P}.tar.gz"
...
# a dependency.
DEPEND="x11-libs/libX11 motif? ( virtual/motif ) !motif? ( x11-libs/libXaw ) >=dev-libs/glib-2.6.0 >=app-emulation/libdsk-1.1.5"
...
src_compile() {
	...
	use motif && my_toolkit="--with-motif1=yes --with-athena=no"
	use motif || my_toolkit="--with-athena=yes --with-motif1=no"
	econf ${my_toolkit} || die "econf failed"
	#
