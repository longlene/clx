...
DESCRIPTION="Rust core for Oxyde ORM - high-performance database operations"
HOMEPAGE="https://github.com/mr-fatalyst/oxyde"
SRC_URI="
	https://github.com/mr-fatalyst/oxyde/archive/refs/tags/core-v${PV}.tar.gz -> ${P}.gh.tar.gz
	${CARGO_CRATE_URIS}
"
S="${WORKDIR}/oxyde-core-v${PV}/crates/oxyde-core-py"
...
QA_FLAGS_IGNORED="usr/lib/py.*/site-packages/.*_oxyde_core.*\.so"
