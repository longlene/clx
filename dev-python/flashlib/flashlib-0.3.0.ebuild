...
HOMEPAGE="
	https://pypi.org/project/flashlib/
	https://flashml-org.github.io/
	https://github.com/FlashML-org/flashlib
"
SRC_URI="https://github.com/FlashML-org/flashlib/archive/refs/tags/v${PV}.tar.gz -> ${P}.gh.tar.gz"
...
RDEPEND="
	...
	$(python_gen_cond_dep '
		>=dev-python/triton-3.6[${PYTHON_USEDEP}]
