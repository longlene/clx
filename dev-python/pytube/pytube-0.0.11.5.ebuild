...
HOMEPAGE="http://marcosrodriguez.me/pytube"
SRC_URI="http://christian.schokokeks.org/${PN}/${P}.tar.gz"
...
pkg_setup() {
    ...
    if ! built_with_use media-video/ffmpeg sdl; then
	die "media-video/ffmpeg needs to be built with USE=\"sdl\""
    fi
}
