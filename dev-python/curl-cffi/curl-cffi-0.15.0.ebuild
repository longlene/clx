...
"
SRC_URI="
	https://github.com/lexiforest/curl_cffi/archive/refs/tags/v${PV}.tar.gz
		-> ${P}.gh.tar.gz
	https://github.com/curl/curl/archive/${CURL_VERSION}.tar.gz
		-> curl-${CURL_PV}.gh.tar.gz
	https://github.com/lexiforest/curl-impersonate/archive/refs/tags/v${CURL_IMPERSONATE_PV}.tar.gz
		-> curl-impersonate-${CURL_IMPERSONATE_PV}.gh.tar.gz
...
src_prepare() {
	default
	eapply "${FILESDIR}"/curl-cffi-0.15.0-build-fix.patch
