...
DESCRIPTION="WebApps in pure Python"
HOMEPAGE="
...
RDEPEND="
	...
	>=dev-python/gitignore-parser-0.1.11[${PYTHON_USEDEP}]
	>=dev-python/imy-0.6.1[${PYTHON_USEDEP}]
	>=dev-python/introspection-1.9.9[${PYTHON_USEDEP}]
	...
	>=dev-python/python-multipart-1.2.0[${PYTHON_USEDEP}]
"
#BDEPEND="
#	test? (
#	)
