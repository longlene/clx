...
DESCRIPTION="OpenTelemetry Google Cloud Logging Exporter"
HOMEPAGE="
	https://pypi.org/project/opentelemetry-exporter-gcp-logging/
...
RDEPEND="
	>=dev-python/google-cloud-logging-3.0[${PYTHON_USEDEP}]
