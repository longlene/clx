...
SRC_URI="
	...
	https://github.com/emscripten-core/emscripten-fastcomp/archive/1.40.1.tar.gz -> ${PN}-fastcomp-1.40.1.tar.gz
	https://github.com/emscripten-core/emscripten-fastcomp-clang/archive/1.40.1.tar.gz -> ${PN}-fastcomp-clang-1.40.1.tar.gz
"
