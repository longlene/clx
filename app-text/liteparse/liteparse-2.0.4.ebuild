...
SRC_URI="
	https://github.com/run-llama/liteparse/archive/refs/tags/crates-v${PV}.tar.gz
		-> liteparse-crates-${PV}.gh.tar.gz
	${CARGO_CRATE_URIS}
"

S="${WORKDIR}/liteparse-crates-v${PV}"
LICENSE="
	Apache-2.0
