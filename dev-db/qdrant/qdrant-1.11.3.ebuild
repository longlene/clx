...
CRATES="
	...
	libz-sys@1.1.8
	lindera-analyzer@0.32.2
	lindera-assets@0.32.2
	lindera-cc-cedict-builder@0.32.2
	lindera-cc-cedict@0.32.2
	lindera-compress@0.32.2
	lindera-core@0.32.2
	lindera-decompress@0.32.2
	lindera-dictionary-builder@0.32.2
	lindera-dictionary@0.32.2
	lindera-filter@0.32.2
	lindera-ipadic-builder@0.32.2
	lindera-ipadic-neologd-builder@0.32.2
	lindera-ipadic-neologd@0.32.2
	lindera-ipadic@0.32.2
	lindera-ko-dic-builder@0.32.2
	lindera-ko-dic@0.32.2
	lindera-tokenizer@0.32.2
	lindera-unidic-builder@0.32.2
	lindera-unidic@0.32.2
	lindera@0.32.2
...
declare -A GIT_CRATES=(
	[quantization]='https://github.com/qdrant/quantization;0caf67d96f022a792bda2e41fa878ba1e113113f;quantization-%commit%/quantization'
	[wal]='https://github.com/qdrant/wal;7c9202d0874b719212e6eacedaa795bfdf43199c;wal-%commit%'
)
...
SRC_URI="
	https://github.com/qdrant/qdrant/archive/refs/tags/v${PV}.tar.gz -> ${P}.gh.tar.gz
	${CARGO_CRATE_URIS}
"
