...
IUSE="doc kerberos kernel_linux nls pam perl -pg_legacytimestamp python selinux tcl test uuid xml debug"
...
STRIP_MASK="/usr/lib64/postgresql-9.3/bin/* /usr/lib64/postgresql-9.3/lib64/* "
