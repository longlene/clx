...
DESCRIPTION="Tokenizer-Free TTS for Multilingual Speech Generation and Voice Cloning"
HOMEPAGE="
...
RDEPEND="
	...
	>=sci-ml/datasets-3[${PYTHON_SINGLE_USEDEP}]
	...
	$(python_gen_cond_dep '
		...
		dev-python/spaces[${PYTHON_USEDEP}]
