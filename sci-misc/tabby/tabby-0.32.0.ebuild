...
declare -A GIT_CRATES=(
	...
	[sqlx-core]='https://github.com/wsxiaoys/sqlx;77eb94dd672531bf1fec190aadf2f742cfb5a8db;sqlx-%commit%/sqlx-core'
	[sqlx-macros-core]='https://github.com/wsxiaoys/sqlx;77eb94dd672531bf1fec190aadf2f742cfb5a8db;sqlx-%commit%/sqlx-macros-core'
	[sqlx-macros]='https://github.com/wsxiaoys/sqlx;77eb94dd672531bf1fec190aadf2f742cfb5a8db;sqlx-%commit%/sqlx-macros'
	[sqlx-mysql]='https://github.com/wsxiaoys/sqlx;77eb94dd672531bf1fec190aadf2f742cfb5a8db;sqlx-%commit%/sqlx-mysql'
	[sqlx-postgres]='https://github.com/wsxiaoys/sqlx;77eb94dd672531bf1fec190aadf2f742cfb5a8db;sqlx-%commit%/sqlx-postgres'
	[sqlx-sqlite]='https://github.com/wsxiaoys/sqlx;77eb94dd672531bf1fec190aadf2f742cfb5a8db;sqlx-%commit%/sqlx-sqlite'
	[sqlx]='https://github.com/wsxiaoys/sqlx;77eb94dd672531bf1fec190aadf2f742cfb5a8db;sqlx-%commit%'
...
SRC_URI="
	https://github.com/TabbyML/tabby/archive/refs/tags/v${PV}.tar.gz -> ${P}.gh.tar.gz
	${CARGO_CRATE_URIS}
"
...
src_prepare() {
	default
	# vendored metrics-0.22.3 no longer builds with rust >= 1.95
	pushd "${WORKDIR}/cargo_home/gentoo/metrics-0.22.3" >/dev/null || die
	eapply "${FILESDIR}/metrics-0.22.3-rust-1.95.patch"
	sed -i 's|"files":{[^}]*}|"files":{}|' .cargo-checksum.json || die
	popd >/dev/null || die
}
