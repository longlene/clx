...
SRC_URI="https://github.com/astaxie/beego/archive/v${PV}.tar.gz -> ${P}.tar.gz
	...
	https://github.com/ssdb/gossdb/archive/a19fc4ae2aa1889d4d7a1e2279ed5907825c8215.tar.gz -> gossdb-a19fc4ae2aa1889d4d7a1e2279ed5907825c8215.tar.gz"

DESCRIPTION="High-performance web framework for Go"
HOMEPAGE="https://https://github.com/astaxie/beego"
LICENSE="Apache-2.0"
SLOT="0/${PVR}"
IUSE=""
RESTRICT="test"
...
unpack_go_packages() {
	...
	for x in ${A}; do
		if [[ ${x} == *.tar.gz ]]; then
			...
			tar -C "${S}/src/${go_package}" -x --strip-components 1 \
				-f "${DISTDIR}/${x}"
		fi
	done
}
