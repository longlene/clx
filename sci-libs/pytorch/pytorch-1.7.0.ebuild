...
https://github.com/google/benchmark/archive/v1.5.0.tar.gz -> benchmark-1.5.0.tar.gz
...
https://github.com/intel/ideep/archive/v2.0.0.tar.gz -> ideep-2.0.0.tar.gz
...
https://github.com/NVlabs/cub/archive/1.9.10.tar.gz -> cub-1.9.10.tar.gz
https://github.com/onnx/onnx/archive/v1.7.0.tar.gz -> onnx-1.7.0.tar.gz
...
https://github.com/shibatch/sleef/archive/3.4.1.tar.gz -> sleef-3.4.1.tar.gz
