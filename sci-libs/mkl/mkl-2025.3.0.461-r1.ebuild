...
SRC_URI="
	https://apt.repos.intel.com/oneapi/pool/main/intel-oneapi-mkl-classic-devel-${PN_VER}-${MY_PV}_amd64.deb
	...
	https://apt.repos.intel.com/oneapi/pool/main/intel-oneapi-mkl-devel-${PN_VER}-${MY_PV}_amd64.deb

	https://apt.repos.intel.com/oneapi/pool/main/intel-oneapi-mkl-cluster-${PN_VER}-${MY_PV}_amd64.deb
	https://apt.repos.intel.com/oneapi/pool/main/intel-oneapi-mkl-cluster-devel-${PN_VER}-${MY_PV}_amd64.deb
