...
RDEPEND="${DEPEND}
	...
	>=sci-libs/openvino-2023.2.0[${PYTHON_SINGLE_USEDEP}]
	>=sci-libs/openvino-telemetry-2022.1.0[${PYTHON_SINGLE_USEDEP}]
	>=sci-libs/openvino-dev-2023.2.0[${PYTHON_SINGLE_USEDEP}]
	$(python_gen_cond_dep '
