...
RDEPEND="
	>=sci-libs/transformers-4.45.2[${PYTHON_SINGLE_USEDEP}]
	>=sci-libs/datasets-2.18.0[${PYTHON_SINGLE_USEDEP}]
	>=sci-libs/lightning-2.1.0[${PYTHON_SINGLE_USEDEP}]
	>=sci-libs/tensorboard-2.14.1[${PYTHON_SINGLE_USEDEP}]
	>=sci-libs/vector-quantize-pytorch-1.14.24[${PYTHON_SINGLE_USEDEP}]
	sci-libs/faster-whisper[${PYTHON_SINGLE_USEDEP}]
	sci-libs/silero-vad[${PYTHON_SINGLE_USEDEP}]
	>=sci-libs/funasr-1.1.5[${PYTHON_SINGLE_USEDEP}]
	$(python_gen_cond_dep '
		...
		>=sci-libs/modelscope-1.17.1[${PYTHON_USEDEP}]
