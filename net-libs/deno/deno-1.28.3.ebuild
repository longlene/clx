...
if [ "${PV}" == "9999" ]; then
	...
	SRC_URI="!build-v8? ( https://github.com/denoland/rusty_v8/releases/download/v0.58.0/librusty_v8_release_x86_64-unknown-linux-gnu.a )"
else
	SRC_URI="$(cargo_crate_uris ${CRATES})
	https://github.com/denoland/${PN}/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	!build-v8? ( https://github.com/denoland/rusty_v8/releases/download/v0.58.0/librusty_v8_release_x86_64-unknown-linux-gnu.a )"
	KEYWORDS="~amd64"
fi
...
src_unpack() {
	if ! use build-v8; then
		...
		mkdir -p "${T}/v0.58.0" || die
		ln -s "${DISTDIR}/librusty_v8_release_x86_64-unknown-linux-gnu.a" "${T}/v0.58.0/librusty_v8_release_x86_64-unknown-linux-gnu.a" || die
	fi
