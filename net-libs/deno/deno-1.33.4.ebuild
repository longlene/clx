...
SRC_URI="$(cargo_crate_uris ${CRATES})
	...
	!build-v8? ( https://github.com/denoland/rusty_v8/releases/download/v${V8_VER}/librusty_v8_release_x86_64-unknown-linux-gnu.a -> librusty_v8-${V8_VER}_x86_64-unknown-linux-gnu.a )"
KEYWORDS="~amd64"
...
src_unpack() {
	if ! use build-v8; then
		...
		mkdir -p "${T}/v${V8_VER}" || die
		ln -s "${DISTDIR}/librusty_v8-${V8_VER}_x86_64-unknown-linux-gnu.a" "${T}/v${V8_VER}/librusty_v8_release_x86_64-unknown-linux-gnu.a" || die
	fi
	cargo_src_unpack
}
