...
SRC_URI="mirror://sourceforge/tuxguitar/tuxguitar-src-${PV}-rc2.tar.gz"
LICENSE="GPL-2"
SLOT="0"
...
S=${WORKDIR}/tuxguitar-src-${PV}-rc2/TuxGuitar
...
src_install() {
	...
	cp share/skins/Lavender/icon.png ${D}/usr/share/pixmaps/tuxguitar-icon.png
