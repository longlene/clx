...
#
# fixed dependencies: >=libpng-1.4.0
# fixed 
#
...
#	>=libpng-1.0.9		>=media-libs/libpng-1.4.0	emul-linux-x86-baselibs
...
src_unpack() {
	...
	epatch ${FILESDIR}/bjfilter-2.50-libpng.patch || die
}
...
pkg_postinst() {
	...
	einfo " https://bugs.gentoo.org/show_bug.cgi?id=128560"
