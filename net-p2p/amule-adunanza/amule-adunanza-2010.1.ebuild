...
MY_P=${P/amule-adunanza/aMule-AdunanzA}"-2.2.6"

DESCRIPTION="aMule Adunanza, the all-platform eMule p2p client for FastWeb customers."
HOMEPAGE="http://www.adunanza.net/"
SRC_URI="mirror://sourceforge/${PN}/aMule-AdunanzA/Stable/${MY_P}.tar.bz2"
S=${WORKDIR}/${MY_P}
