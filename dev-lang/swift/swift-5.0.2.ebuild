...
SRC_URI="
	...
	https://github.com/apple/swift-llvm/archive/swift-${PV}-RELEASE.tar.gz -> swift-llvm-${PV}.tar.gz
	https://github.com/apple/swift-clang/archive/swift-${PV}-RELEASE.tar.gz -> swift-clang-${PV}.tar.gz
	https://github.com/apple/swift-clang-tools-extra/archive/swift-${PV}-RELEASE.tar.gz -> swift-clang-tools-extra-${PV}.tar.gz
	https://github.com/apple/swift-libcxx/archive/swift-${PV}-RELEASE.tar.gz -> swift-libcxx-${PV}.tar.gz
	https://github.com/apple/swift-lldb/archive/swift-${PV}-RELEASE.tar.gz -> swift-lldb-${PV}.tar.gz
	...
	https://github.com/apple/swift-compiler-rt/archive/swift-${PV}-RELEASE.tar.gz -> swift-compiler-rt-${PV}.tar.gz
...
src_unpack() {
	...
	for sdir in llvm clang clang-tools-extra libcxx lldb cmark llbuild compiler-rt ; do
