...
DESCRIPTION="Dynamic Bandwidth Detection plugin for the Wowza Media Server."
SRC_URI="http://www.wowzamedia.com/downloads/${MY_WPN}-${MY_PV_ORIG//./-}/${MY_PKG}"
HOMEPAGE="http://www.wowzamedia.com/forums/showthread.php?t=169"
...
src_install() {
	...
	if use examples; then
		...
		echo "mkdir /etc/wowza-media-server/applications/bwcheck" >> ${INST} || die
