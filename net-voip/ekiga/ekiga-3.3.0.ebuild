...
RDEPEND=">=dev-libs/glib-2.14.0:2
	dev-libs/libsigc++:2
	dev-libs/libxml2:2
	>=net-libs/opal-3.8.3[audio,sip,video,debug=,h323?]
	>=net-libs/ptlib-2.8.3[stun,video,wav,debug=]
...
src_prepare() {
	epatch "${FILESDIR}"/${P}-plugins_resource-list_parentheses.patch
	epatch "${FILESDIR}"/${P}-plugins_resource-list_const-iterator.patch
