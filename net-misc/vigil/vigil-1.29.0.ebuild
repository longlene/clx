...
DESCRIPTION="Microservices status page with alerting for distributed infrastructure"
HOMEPAGE="https://github.com/valeriansaliou/vigil"
SRC_URI="
	https://github.com/valeriansaliou/vigil/archive/refs/tags/v${PV}.tar.gz -> ${P}.gh.tar.gz
	${CARGO_CRATE_URIS}
"
...
DEPEND="
	net-libs/libssh2:=
	virtual/zlib
	xmpp? ( dev-libs/libstrophe:= )
"
RDEPEND="${DEPEND}"

src_compile() {
	local myfeatures=(
		$(usev xmpp notifier-xmpp)
	)
