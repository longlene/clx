...
ruby_add_rdepend "=dev-ruby/cinch-2.3.1"
ruby_add_rdepend ">=dev-ruby/thor-0.19.1"
ruby_add_rdepend "=dev-ruby/eventmachine-1.0.8"
ruby_add_rdepend ">=dev-ruby/eventmachine_httpserver-0.2.1"
ruby_add_rdepend ">=dev-ruby/nokogiri-1.6.6.4"
ruby_add_rdepend ">=dev-ruby/daemons-1.2.3"
ruby_add_rdepend ">=dev-ruby/twitter-5.15.0"
