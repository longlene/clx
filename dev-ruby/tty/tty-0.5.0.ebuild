...
ruby_add_rdepend ">=dev-ruby/tty-command-0.1.0"
ruby_add_rdepend ">=dev-ruby/tty-pager-0.4.0"
ruby_add_rdepend ">=dev-ruby/tty-platform-0.1.0"
ruby_add_rdepend ">=dev-ruby/tty-progressbar-0.9.0"
ruby_add_rdepend ">=dev-ruby/tty-prompt-0.6.0"
ruby_add_rdepend ">=dev-ruby/tty-screen-0.5.0"
ruby_add_rdepend ">=dev-ruby/tty-spinner-0.2.0"
ruby_add_rdepend ">=dev-ruby/tty-table-0.5.0"
