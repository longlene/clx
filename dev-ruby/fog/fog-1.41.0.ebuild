...
ruby_add_rdepend ">=dev-ruby/fog-core-1.45"
...
ruby_add_rdepend ">=dev-ruby/fog-cloudatcost-0.1.0"
ruby_add_rdepend ">=dev-ruby/fog-digitalocean-0.3.0"
ruby_add_rdepend ">=dev-ruby/fog-dnsimple-1.0"
...
ruby_add_rdepend ">=dev-ruby/fog-internet-archive-0"
ruby_add_rdepend ">=dev-ruby/fog-joyent-0"
ruby_add_rdepend ">=dev-ruby/fog-local-0"
ruby_add_rdepend ">=dev-ruby/fog-openstack-0"
ruby_add_rdepend ">=dev-ruby/fog-powerdns-0.1.1"
ruby_add_rdepend ">=dev-ruby/fog-profitbricks-0"
ruby_add_rdepend ">=dev-ruby/fog-rackspace-0"
