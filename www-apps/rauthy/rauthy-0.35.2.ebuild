...
DESCRIPTION="OpenID Connect / OAuth 2 Single Sign-On Identity and Access Management server"
HOMEPAGE="https://github.com/sebadob/rauthy https://sebadob.github.io/rauthy/"
SRC_URI="
	https://github.com/sebadob/rauthy/archive/refs/tags/v${PV}.tar.gz -> ${P}.gh.tar.gz
	${CARGO_CRATE_URIS}
"
...
src_prepare() {
	# Extract pre-built frontend assets (generated by npm/Svelte build, archived at release time)
	mkdir -p static || die
	tar -xf assets/static_html/static_v1.tar.gz || die
	tar -xf assets/static_html/templates_html.tar.gz || die
	default
}

src_install() {
	cargo_src_install --path src/bin
