...
src_install() {
	...
	into "/${tuxdir}"
	dolib.so ${CLIENT_DATA_DIR}/lib*$(get_libname)*
	...
	doins ${CLIENT_DATA_DIR}/{atmi.h,fml32.h,tmenv.h,userlog.h}
	...
	if use server ; then
		for f in tmadmin  tmboot  tmconfig  tmipcrm tmloadcf tmshutdown tmunloadcf build_server dmadmin dmloadcf dmunloadcf GWADM GWTDOMAIN ; do
