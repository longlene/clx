...
inherit libtool flag-o-matic eutils python autotools prefix toolchain-funcs
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${P}-icu-config.patch
}
...
src_configure() {
	...
	tc-is-cross-compiler && ICU_CONFIG=${ROOT}${ICU_CONFIG}

	ICU_CONFIG=${ICU_CONFIG} econf ${myconf}
}
