...
SRC_URI="
	https://github.com/ggml-org/ggml/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
"
...
IUSE="blis cuda flexiblas openblas opencl +openmp openvino rocm sycl test vulkan wmma"
RESTRICT="!test? ( test )"
...
src_prepare() {
	use openvino && eapply "${FILESDIR}/${P}-openvino-system-tbb.patch"
