...
RDEPEND="
	...
	$(python_gen_cond_dep '
		...
		>=dev-python/opentelemetry-api-1.42.0[${PYTHON_USEDEP}]
		>=dev-python/opentelemetry-sdk-1.42.0[${PYTHON_USEDEP}]
		>=dev-python/opentelemetry-exporter-otlp-proto-http-1.42.0[${PYTHON_USEDEP}]
		>=sci-ml/chromadb-1.1.0[${PYTHON_USEDEP}]
