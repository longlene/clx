...
EGIT_COMMIT="04611f34764e21367543ad9a7eb6d15b02d6b4d2"
...
RDEPEND="
	...
	$(python_gen_cond_dep '
		...
		|| (
			>=sci-ml/pysentencepiece-0.2.0[${PYTHON_SINGLE_USEDEP}]
			>=sci-ml/sentencepiece-0.2.0[python,${PYTHON_SINGLE_USEDEP}]
		)
		...
		dev-python/cut_cross_entropy[${PYTHON_USEDEP}]
