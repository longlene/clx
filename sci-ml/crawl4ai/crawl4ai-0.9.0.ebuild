...
IUSE="pdf torch transformer"

RDEPEND="
	$(python_gen_cond_dep '
		sci-misc/unclecode-litellm[${PYTHON_USEDEP}]
		...
		>=dev-python/playwright-stealth-2.0.0[${PYTHON_USEDEP}]
		...
		torch? ( >=dev-python/scikit-learn-1.0[${PYTHON_USEDEP}] )
	')
	torch? ( sci-ml/pytorch[${PYTHON_SINGLE_USEDEP}] )
	transformer? (
