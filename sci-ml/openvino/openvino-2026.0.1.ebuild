...
ONEDNN_CPU_COMMIT="c6b79c1207bd5f20b9395536dab1d71a47cfcb1d"
ONEDNN_GPU_COMMIT="929fe4e5629be2a5e89f1ba13b13458b965ffe57"
...
src_prepare() {
	...
	eapply \
		...
		"${FILESDIR}"/030-openvino-fix-pybind11-compatibility.patch \
