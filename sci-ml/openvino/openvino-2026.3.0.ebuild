...
ONEDNN_CPU_COMMIT="f82d833de6f13fac4bb1926d521ca8fec4f4ae01"
ONEDNN_GPU_COMMIT="babb7375ff500dd8ad77d26cbd2b044122b7a8b4"
CONTRIB_COMMIT="b5e18c1ccc884c028d182712c3960ec03fcb22c1"
...
src_prepare() {
	...
	eapply \
		...
		"${FILESDIR}"/onednn-gpu-libdir.patch
	...
	rmdir src/plugins/intel_cpu/thirdparty/onednn &&
		ln -sv "${WORKDIR}"/oneDNN-${ONEDNN_CPU_COMMIT} src/plugins/intel_cpu/thirdparty/onednn
	rmdir src/plugins/intel_gpu/thirdparty/onednn_gpu &&
		ln -sv "${WORKDIR}"/oneDNN-${ONEDNN_GPU_COMMIT} src/plugins/intel_gpu/thirdparty/onednn_gpu
	if use contrib ; then
