...
RDEPEND="
	>=sci-ml/pytorch-2.1.2[${PYTHON_SINGLE_USEDEP}]
	$(python_gen_cond_dep '
		>=sci-ml/torchvision-0.16.2[${PYTHON_USEDEP}]
		>=sci-ml/torchaudio-2.1.2[${PYTHON_USEDEP}]
		>=sci-ml/transformers-4.43.4[${PYTHON_USEDEP}]
		>=sci-ml/tokenizers-0.19.1[${PYTHON_USEDEP}]
		>=dev-python/sentencepiece-0.1.99[${PYTHON_USEDEP}]
		dev-python/shortuuid[${PYTHON_USEDEP}]
		>=sci-ml/accelerate-0.33.0[${PYTHON_USEDEP}]
		>=sci-ml/peft-0.11.1[${PYTHON_USEDEP}]
