...
CRATES="
	...
	wasm-bindgen-test-macro@0.3.75
	wasm-bindgen-test-shared@0.2.125
...
HOMEPAGE="https://ast-grep.github.io/ https://github.com/ast-grep/ast-grep"
SRC_URI="
	https://github.com/ast-grep/ast-grep/archive/refs/tags/${PV}.tar.gz -> ${P}.gh.tar.gz
	${CARGO_CRATE_URIS}
"
