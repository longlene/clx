...
# TODO: Add 'tools' flag.
IUSE="captcha debug full-xml graphics ldap mssql mysql nls odbc pam postgres redis roster-gw sip sqlite stun zlib"
...
CDEPEND="
	...
	>=dev-erlang/xmpp-1.5.4
	>=dev-lang/erlang-17.1[odbc?,ssl]
	...
	postgres? ( >=dev-erlang/p1_pgsql-1.1.12 )
	redis? ( >=dev-erlang/eredis-1.0.8 )
	sip? ( >=dev-erlang/esip-1.0.43 )
	sqlite? ( >=dev-erlang/sqlite3-1.1.13 )
	stun? ( >=dev-erlang/stun-1.0.44 )
