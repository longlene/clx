...
# TODO: )
CDEPEND="
	>=dev-erlang/cache_tab-1.0.26
	>=dev-erlang/eimp-1.0.18
	>=dev-erlang/fast_tls-1.1.10
	>=dev-erlang/fast_xml-1.1.45
	>=dev-erlang/fast_yaml-1.0.29
	>=dev-erlang/yconf-1.0.9
	>=dev-erlang/idna-6.0.0
	>=dev-erlang/jiffy-1.0.1
	>=dev-erlang/jose-1.9.0
	>=dev-erlang/lager-3.6.10
	>=dev-erlang/luerl-0.3
	>=dev-erlang/mqtree-1.0.11
	>=dev-erlang/p1_acme-1.0.10
