...
QT_MOBILITY_MODULES="bearer contacts gallery location messaging publishsubscribe
multimedia systeminfo serviceframework sensors versit organizer feedback
connectivity"
